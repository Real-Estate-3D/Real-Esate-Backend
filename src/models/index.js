...
db.LowerTier.belongsTo(db.UpperTier, { foreignKey: 'upper_tier_id', as: 'upperTier' });
db.UpperTier.hasMany(db.LowerTier, { foreignKey: 'upper_tier_id', as: 'lowerTiers' });

db.Ward.belongsTo(db.LowerTier, { foreignKey: 'lower_tier_id', as: 'lowerTier' });
db.Ward.belongsTo(db.SingleTier, { foreignKey: 'single_tier_id', as: 'singleTier' });
...
db.Legislation.hasMany(db.LegislationVersion, { foreignKey: 'legislation_id', as: 'versions' });
db.LegislationVersion.belongsTo(db.Legislation, { foreignKey: 'legislation_id' });

db.Legislation.hasMany(db.LegislationBranch, { foreignKey: 'legislation_id', as: 'branches' });
db.LegislationBranch.belongsTo(db.Legislation, { foreignKey: 'legislation_id' });

db.LegislationBranch.belongsTo(db.LegislationBranch, { foreignKey: 'parent_branch_id', as: 'parentBranch' });
db.LegislationBranch.hasMany(db.LegislationBranch, { foreignKey: 'parent_branch_id', as: 'childBranches' });

db.Legislation.hasMany(db.ZoningLaw, { foreignKey: 'legislation_id', as: 'zoningLaws' });
db.ZoningLaw.belongsTo(db.Legislation, { foreignKey: 'legislation_id' });

db.Legislation.hasMany(db.Policy, { foreignKey: 'legislation_id', as: 'policies' });
db.Policy.belongsTo(db.Legislation, { foreignKey: 'legislation_id' });

db.Legislation.hasMany(db.GISSchedule, { foreignKey: 'legislation_id', as: 'gisSchedules' });
db.GISSchedule.belongsTo(db.Legislation, { foreignKey: 'legislation_id' });

db.GISSchedule.belongsTo(db.GISLayer, { foreignKey: 'gis_layer_id', as: 'layer' });
db.GISLayer.hasMany(db.GISSchedule, { foreignKey: 'gis_layer_id', as: 'schedules' });

// A legislation references a workflow template via workflow_id
db.Legislation.belongsTo(db.Workflow, { foreignKey: 'workflow_id', as: 'workflow' });
db.Workflow.hasMany(db.Legislation, { foreignKey: 'workflow_id', as: 'legislations' });

db.Workflow.hasMany(db.WorkflowStep, { foreignKey: 'workflow_id', as: 'steps' });
db.WorkflowStep.belongsTo(db.Workflow, { foreignKey: 'workflow_id' });

// User associations
db.User.belongsToMany(db.Role, { through: db.UserRole, foreignKey: 'user_id', as: 'roles' });
db.Role.belongsToMany(db.User, { through: db.UserRole, foreignKey: 'role_id', as: 'users' });
...
db.LegislationVersion.belongsTo(db.User, { foreignKey: 'created_by', as: 'creator' });
db.LegislationBranch.belongsTo(db.User, { foreignKey: 'created_by', as: 'creator' });
